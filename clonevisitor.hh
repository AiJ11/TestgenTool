...
private:
    ...
    unique_ptr<Expr> cloneBoolConst(const class BoolConst &node);
    unique_ptr<Expr> cloneBinaryOpExpr(const class BinaryOpExpr &node);
    unique_ptr<Expr> cloneUnaryOpExpr(const class UnaryOpExpr &node);
