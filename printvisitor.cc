...
void PrintVisitor::visitBoolConst(const BoolConst &node) {
    cout << (node.value ? "true" : "false");
}

void PrintVisitor::visitBinaryOpExpr(const BinaryOpExpr &node) {
    cout << "(";
    
    // Print operator name
    switch (node.op) {
        case BinOp::EQ: cout << "Eq "; break;
        case BinOp::NEQ: cout << "Neq "; break;
        case BinOp::LT: cout << "Lt "; break;
        case BinOp::LE: cout << "Le "; break;
        case BinOp::GT: cout << "Gt "; break;
        case BinOp::GE: cout << "Ge "; break;
        case BinOp::AND: cout << "And "; break;
        case BinOp::OR: cout << "Or "; break;
        case BinOp::IMPLIES: cout << "Implies "; break;
        case BinOp::IN: cout << "In "; break;
        case BinOp::NOT_IN: cout << "NotIn "; break;
    }
...
void PrintVisitor::visitUnaryOpExpr(const UnaryOpExpr &node) {
    cout << "(";
    
    switch (node.op) {
        case UnOp::NOT: cout << "Not "; break;
    }
...
void PrintVisitor::visitAssert(const Assert &node) {
    cout << "assert(";
    if (node.expr) {
        visit(node.expr.get());
    }
