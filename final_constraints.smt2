...
(assert (! (select Dom_U v2) :named c7))
(assert (! (= v6 "E") :named c8))
(assert (! (= v7 "A") :named c9))
(assert (! (= v8 "C") :named c10))
(assert (! (= v9 "B") :named c11))
(assert (! (= v10 "D") :named c12))
(assert (! true :named c13))
(assert (! (select Dom_U v7) :named c14))
